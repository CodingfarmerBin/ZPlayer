 ...
 */
package com.zqb.baselibrary.http.cookie
 ...
 * ================================================
 */
class SerializableCookie(var host: String?, @field:Transient private val cookie: Cookie) : Serializable {
    ...
    companion object {
        ...
        private fun byteArrayToHexString(bytes: ByteArray): String {
            ...
            for (element in bytes) {
                val char = 0xff.toByte()
                val v = element and char
                if (v < 16) {
                    sb.append('0')
                }
        ...
        private fun hexStringToByteArray(hexString: String): ByteArray {
            ...
            while (i < len) {
                data[i / 2] =
                    ((Character.digit(hexString[i], 16) shl 4) + Character.digit(hexString[i + 1], 16)).toByte()
                i += 2
            }
            return data
        }
